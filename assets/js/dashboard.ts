...
async function buscarDadosDashboard(): Promise<DashboardResponse> {
...
function renderizarIndicadores(dados: DashboardResponse, produtos: ProdutoDashboard[]): void {
...
function renderizarTabelaProdutos(produtos: ProdutoDashboard[]): void {
...
async function inicializarDashboard(): Promise<void> {
    try {
